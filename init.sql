...
CREATE TABLE users (id INT AUTO_INCREMENT, name VARCHAR(20) UNIQUE NOT NULL, password VARCHAR(80), role_id INT, PRIMARY KEY (id), FOREIGN KEY (role_id) REFERENCES roles(id));
...
CREATE TABLE course (id INT AUTO_INCREMENT, version INTEGER DEFAULT '0', subject VARCHAR(20) NOT NULL, specialization VARCHAR(20), location_city VARCHAR(20), location_street VARCHAR(20), location_office INT, instructor_id INT NOT NULL, PRIMARY KEY (id), FOREIGN KEY (instructor_id) REFERENCES instructors (id));
CREATE TABLE students (id INT AUTO_INCREMENT, firstName VARCHAR(20) NOT NULL, lastName VARCHAR(20) NOT NULL, phonenumber BIGINT, city VARCHAR(20), street VARCHAR(20), flat INT, PRIMARY KEY (id));
...
CREATE TABLE reviews (id INT AUTO_INCREMENT, review VARCHAR(60), user_id INT, course_id INT, PRIMARY KEY (id), FOREIGN KEY (user_id)REFERENCES users(id),FOREIGN KEY (course_id)REFERENCES course(id));
...
INSERT INTO users (users.name, users.password, users.role_id) VALUES ('INSTRUCTOR', 'INSTRUCTOR', 2);
